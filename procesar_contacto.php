 ...
 * Aquí es donde recibo los datos del 'contacto.html' y los envío a mi email.
...
if (empty($nombre) || empty($email) || empty($mensaje) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    exit; // Termino el script aquí.
}

// 3. ¡Hora de montar el email que va a recibir el CLIENTE!

// ¿A qué email quiero que me lleguen los mensajes?
$mi_email = "MI_email@gmail.com"; // <-- ¡¡HAY QUE CAMBIAR ESTO por el email del CLIENTE!!

// El asunto del email que recibirÁ el CLIENTE
